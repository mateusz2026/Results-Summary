...
## 📌 Overview
This project is a solution to the Frontend Mentor Results Summary Component challenge.  
...
- Clean UI layout
- Summary sections with scores
- Styled button with hover effect

## 📚 What I learned
- How to structure layout using Flexbox
